    ...
    return (
        <>
            ...
            <div className="w-full h-full relative font-poppins">
                ...
                <ServiceCard className="card card3 top-8 z-20 scale-80 bg-[#b88954] opacity-80 text-gray-900/80" id="service3" service="Graphic Design" 
                ...
                <ServiceCard className="card card4 top-0 z-10 scale-70 bg-[#9c742d] opacity-70 text-white/80" id="service4" service="Web Development" 
